...
<table class="table table-hover">
    ...
    $result = mysqli_query($conn,"SELECT * FROM allotslot WHERE studid=$strx AND statuss='Confirmed' AND feedback='no'");
while($row = mysqli_fetch_array($result)){
  echo "<tr>";
  echo "<td>".$row["reason"]."</td>";
  echo "<td>".$row["slot"]."</td>";
  echo "<td>".$row["statuss"]."</td>";
  echo "<td><a href=\"retMenteeFeedback.php?val=".$row["allotid"]."\"><button type=\"button\" class=\"btn btn-primary\">Give Feedback</button></a><td>";
  echo "</tr>";
