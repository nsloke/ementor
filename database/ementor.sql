...
--
-- Host: localhost
-- Generation Time: Mar 20, 2019 at 10:05 PM
...
INSERT INTO `studinftbl` (`studid`, `studname`, `branch`, `iitentr`, `medofinc`, `mobno`, `resphno`, `resaddr`, `emgrcon`, `relcon`, `emgaddr`, `emgtel`, `email`, `sibedu`, `fambgr`, `income`, `modtrav`, `nativpl`, `freqnativ`, `medhist`, `hobby`, `strength`, `weakness`) VALUES
(545454376, 'Sylvester Stallone', 2, 'no', 'English', '7045468386', '', 'B604, Ganesh co op society\r\nManjrekar wadi, ns phadke marg\r\nAndheri east', '9404170589', 'Father', 'Manjrekarwadi, N.S. Phadke Marg,', '07588858592', 'muscleman.loke74@gmail.com', 'No Siblings', 'Father:Retired\r\nMother:Housewife', 'gt3l', 'Bus', 'Oros', '3', 'Suffered Major fracture', 'Bungee Jumping', 'Biceps, Triceps', 'Calves');
...
--
ALTER TABLE `allotslot`
  MODIFY `allotid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `menteenotif`
--
ALTER TABLE `menteenotif`
  MODIFY `notifyid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
