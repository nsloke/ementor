...
<div class="col-md-8">
<h3>Mentor</h3>
<form action="savementor.php">
  <div class="form-group">
    <label for="email">Staff ID:</label>
    <input type="number" class="form-control" id="staffid" name="staffid" onkeydown="limit(this);" onkeyup="limit(this);">
  </div>
  <div class="form-group">
    <label for="pwd">Staff Name:</label>
    <input type="text" class="form-control" id="staff" name="staffname">
  </div>
  <div class="form-group">
